...
const SHEET_CSV_URL = "https://docs.google.com/spreadsheets/d/e/2PACX-1vS6y_mNf2-Jv_UuF_j-xH_i_v5uF0X6y_mNf2-Jv_UuF_j-xH_i_v5uF0X6y_mNf2-Jv_UuF_j/pub?output=csv";
      ...
      return {
        ...
        history: [
          { 
            id: 'init', 
            type: 'deposito', 
            amount: parseFloat(userRow.ahorros), 
